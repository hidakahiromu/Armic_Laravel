...
@section('content')
<!-- 利用規約 -->
<div class="Terms"><p class="TermsTop">利用規約</p>
  <div class="TermsText">
    この利用規約（以下，「本規約」といいます。）は，＿＿＿＿＿（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。<br>
    <br>
    <p class="TermsTreaty">第1条（適用）</p><br>
    本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。<br>
    当社は本サービスに関し，本規約のほか，ご利用にあたってのルール等，各種の定め（以下，「個別規定」といいます。）をすることがあります。これら個別規定はその名称のいかんに関わらず，本規約の一部を構成するものとします。<br>
    本規約の規定が前条の個別規定の規定と矛盾する場合には，個別規定において特段の定めなき限り，個別規定の規定が優先されるものとします。<br>
    <br>
    <p class="TermsTreaty">第2条（利用登録）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第3条（ユーザーIDおよびパスワードの管理）</p><br>
    ユーザーは，自己の責任において，本サービスのユーザーIDおよびパスワードを適切に管理するものとします。<br>
    ユーザーは，いかなる場合にも，ユーザーIDおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当社は，ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーIDを登録しているユーザー自身による利用とみなします。<br>
    ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，当社に故意又は重大な過失がある場合を除き，当社は一切の責任を負わないものとします。<br>
    <br>
    <p class="TermsTreaty">第4条（利用料金および支払方法）</p><br>
    ユーザーは，本サービスの有料部分の対価として，当社が別途定め，本ウェブサイトに表示する利用料金を，当社が指定する方法により支払うものとします。<br>
    ユーザーが利用料金の支払を遅滞した場合には，ユーザーは年14．6％の割合による遅延損害金を支払うものとします。<br>
    <br>
    <p class="TermsTreaty">第5条（禁止事項）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第6条（本サービスの提供の停止等）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第7条（利用制限および登録抹消）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第8条（退会）</p><br>
    ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。<br>
    <br>
    <p class="TermsTreaty">第9条（保証の否認および免責事項）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第10条（サービス内容の変更等）</p><br>
    当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。<br>
    <br>
    <p class="TermsTreaty">第11条（利用規約の変更）</p><br>
    当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。<br>
    <br>
    <p class="TermsTreaty">第12条（個人情報の取扱い）</p><br>
    当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。<br>
    <br>
    <p class="TermsTreaty">第13条（通知または連絡）</p><br>
    ...
    <br>
    <p class="TermsTreaty">第14条（権利義務の譲渡の禁止）</p><br>
    ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。<br>
    <br>
    <p class="TermsTreaty">第15条（準拠法・裁判管轄）</p><br>
...
<!-- プライバシーポリシー -->
<div class="Privacy"><p class="PrivacyTop">プライバシーポリシー</p>
    <div class="PrivacyText">
    ＿＿＿＿＿＿＿＿（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br>
    <br>
    <p class="PrivacyTreaty">第1条（個人情報）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第2条（個人情報の収集方法）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第3条（個人情報を収集・利用する目的）</p><br>
    ...
    ・上記の利用目的に付随する目的<br>
    <br>
    <p class="PrivacyTreaty">第4条（利用目的の変更）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第5条（個人情報の第三者提供）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第6条（個人情報の開示）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第7条（個人情報の訂正および削除）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第8条（個人情報の利用停止等）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第9条（プライバシーポリシーの変更）</p><br>
    ...
    <br>
    <p class="PrivacyTreaty">第10条（お問い合わせ窓口）</p><br>
